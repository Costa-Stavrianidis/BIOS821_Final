...
from restaurant_functions import Customer

# Create your restaurant profile
"""
In order to have the best experience with our restaurant locator function,
users should follow the directions below as exactly as possible. This includes
following case sensitve actions and numeric inputs. Users may follow the outlined
...
PriceLevel: Indicated on a scale denoted by $, $$, $$$, $$$$ where the greater number of $
implies that the desired price level of the restaurant is higher. This should be between
quotations as such, "$$".

OpeningTime: Using a 24:00 hour clock, users will input the opening hours of which they are
...
RestaurantType: Indicate the type of restaurant is preferred. This preferrence should
match exactly to one of the following options and should be between quotations:
...
desired quality level and may use up to one decimal of exactness (ex. 2.3, 4.6).
"""
